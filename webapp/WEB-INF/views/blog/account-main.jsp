			...
			<!--  *************************** 보안 번호 입력  *************************************** -->	
						...
						$(function(){
							...
							$("#secretNumberSave").click(function(){
								...
								if( secretNumber > 9999 ){
									alert(" 1000 ~ 9999 까지의 숫자를 입력해주세요");
									return false;
								}	
											...
											<div class="tab-pane" id="user_profile">
												<div class="userpage">
														...
														<div class="col-sm-4">
															<div class="input-group">
																<span class="input-group-addon"> <i class="fa fa-group"></i>
																</span> <input id="title" type="text" class="form-control" placeholder="${map.blogVo.title }" name="title">
															</div>
														</div>
														<div class="col-sm-4">
															<div class="input-group">
														...
														<button id="userProfileSave"  class="btn btn-primary btn-sm">저장</button>
											...
											<script>
												...
												$(function(){
													...
													$("#userProfileSave").click(function(){
														...
														$.ajax({
															url:"${pageContext.request.contextPath}/user/account/userprofilemodify",
															type:"post",
															data: formData , 
															processData : false,
												            contentType : false
